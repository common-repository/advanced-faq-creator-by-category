...
<div class="col-lg-<?php esc_attr_e($number_of_colom);?> col-md-<?php esc_attr_e($number_of_colom);?> col-sm-12 col-xs-12   animated <?php if(isset($category_container_options['animation_select']) && $category_container_options['animation_select'] !=''){esc_attr_e($category_container_options['animation_select']);} ?>">
